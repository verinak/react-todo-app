        ...
        <div className="min-h-screen bg-slate-200 p-4 md:p-8 flex justify-center shadow-md">
            {task ? (
                <div className="w-full max-w-md bg-white rounded-2xl p-6 space-y-6 h-fit">
                    ...
                    <div>
                        <p className="mb-1 text-slate-500 font-medium text-sm md:text-base">
                            Priority
                        </p>
                        <span
                            className={`px-4 py-1 rounded-full ${priorityColor[task.priority]["default"]} ${priorityColor[task.priority]["text"]}`}
                        >
